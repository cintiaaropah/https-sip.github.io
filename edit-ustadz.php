...
<html lang="en">
  ...
  * License: https://bootstrapmade.com/license/
  ...
  <?php
    ...
    $data = mysqli_query($koneksi,"SELECT * FROM tb_data_ustadz where id_ustadz = '$id_ustadz'");
...
<div class="card">
  <div class="card-body">
    ...
    <form method="POST" action="action/aksi-edit-ustadz.php?id=<?php echo $id_ustadz?>">
      <div class="row mb-3">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-10">
          <input type="text" name="Tempat-Lahir" class="form-control" value="<?php echo $d['Tempat_Lahir'] ?>">
        </div>
      </div>
      <div class="row mb-2">
        <label for="inputDate" class="col-sm-2 col-form-label">Tanggal Lahir</label>
        <div class="col-sm-10">
          <input type="date" name="Tanggal-Lahir" class="form-control" value="<?php echo $d['Tanggal_Lahir'] ?>">
        </div>
      </div>
      ...
      <div class="row mb-3">
        <label for="inputPassword" class="col-sm-2 col-form-label">Profesi</label>
        <div class="col-sm-10">
          <input type="text" name="Profesi" class="form-control" value="<?php echo $d['Profesi'] ?>">
        </div>
      </div>

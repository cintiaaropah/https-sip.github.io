...
$result = mysqli_query($conn, "SELECT * FROM tb_pelanggaran");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>Catatan Santri / Pelanggaran</title>
  ...
  <li class="nav-item">
    <a class="nav-link collapsed" href="../sign-out.php">
      ...
      <div class="pagetitle">
        <h1>Pelanggaran</h1>
        <nav>
          <a href="tambah-pelanggaran.php" class="btn btn-primary">Tambah </a>
        </nav>
      </div>
      <!-- End Page Title -->
              ...
              <div class="card-body">
                ...
                <table class="table table-hover">
                  <thead>
                    ...
                    $query="SELECT * FROM tb_pelanggaran where Nama like '%{$_GET['cari']}%'";
                    } else{
                   ...
                   while ($d = mysqli_fetch_array($data)){
                    ...
                    <tr>
                      ...
                      <th><?php echo $d['Pelanggaran']; ?></th>
                      <th><?php echo $d['Tanggal']; ?></th>
                      <th><?php echo $d['Hukuman']; ?></th>
                      <th>
                      <div class="btn-group">
                      <a href="edit-pelanggaran.php?id_Pelanggaran=<?php echo $d['id_Pelanggaran']?>" class="btn btn-warning">Edit</a>
                        <button type="button" class="btn btn-danger btn-delete" data-delete="action/aksi-hapus-pelanggaran.php?id=<?php echo $d['id_Pelanggaran'];?>&table=tb_pelanggaran" data-bs-toggle="modal" data-bs-target="#basicModal">Hapus</button>
                        </div>
                       </th>
                     </tr>
                     <?php } ?>

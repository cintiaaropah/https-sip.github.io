...
<html lang="en">
  ...
  * License: https://bootstrapmade.com/license/
  ...
  <body>
    ...
    $data = mysqli_query($koneksi,"SELECT * FROM tb_data_santri where id_santri = '$id_santri'");
...
<div class="card">
  <div class="card-body">
    ...
    <form method="POST" action="action/aksi-edit-santri.php?id=<?php echo $id_santri?>">
      <div class="row mb-3">

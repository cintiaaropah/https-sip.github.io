...
<html lang="en">
  <head>
    ...
    <title>Edit Jadwal Sambangan</title>
  ...
  * License: https://bootstrapmade.com/license/
  ...
  <?php
    include '../koneksi.php';
    $id_js = $_GET['id_js'];
    $data = mysqli_query($koneksi,"SELECT * FROM tb_js where id_js = '$id_js'");
...
<div class="card">
  <div class="card-body">
    <h5 class="card-title">Isi Jadwal Sambangan</h5>

    <!-- General Form Elements -->
    <form method="POST" action="action/aksi-edit-js.php?id=<?php echo $id_js?>">
      <div class="row mb-3">
        <label for="inputText" class="col-sm-2 col-form-label">Periode</label>
        <div class="col-sm-10">
          <input type="text" name="Periode" class="form-control" value="<?php echo $d['Periode'] ?>">
        </div>
      </div>
      <div class="row mb-2">

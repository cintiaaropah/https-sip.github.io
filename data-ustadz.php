...
$result = mysqli_query($conn, "SELECT * FROM tb_data_ustadz");
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>Master Data / Data Pengurus</title>
...
<ul class="sidebar-nav" id="sidebar-nav">
  ...
  <li class="nav-item">
    ...
    <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
      ...
      <li>
        <a href="data-ustadz.php" class="active">
...
<li class="nav-item">
   ...
   <main id="main" class="main">
      <div class="pagetitle">
        ...
        <a href="tambah-ustadz.php" class="btn btn-primary">Tambah</a>
        </nav>
      </div>
      <!-- End Page Title -->
                ...
                <table class="table table-hover">
                  <thead>
                   ...
                   include '../koneksi.php';
                    ...
                    $query="SELECT * FROM tb_data_ustadz where Nama like '%{$_GET['cari']}%'";
                    } else{
                    $query="SELECT * FROM tb_data_ustadz";
                    }                 
                   ...
                   while ($d = mysqli_fetch_array($data)){
                    ...
                    <tr>
                      ...
                      <th><?php echo $d['Jk']; ?></th>
                      <th><?php echo $d['Profesi']; ?></th>
                      <th>
                        <div class="btn-group">
                        <a href="edit-ustadz.php?id_ustadz=<?php echo $d['id_ustadz']?>" class="btn btn-warning">Edit</a>
                        <button type="button" class="btn btn-danger btn-delete" data-delete="action/aksi-hapus-ustadz.php?id=<?php echo $d['id_ustadz'];?>&table=tb_data_ustadz" data-bs-toggle="modal" data-bs-target="#basicModal">Hapus</button>
                        </div>
                       </th>
                     </tr>
                     <?php } ?>

...
<html lang="en">
  ...
  * License: https://bootstrapmade.com/license/
  ...
  <?php
    ...
    $data = mysqli_query($koneksi,"SELECT * FROM tb_prestasi where id_Prestasi = '$id_Prestasi'");
...
<main id="main" class="main">
      <div class="pagetitle">
       ...
       <form method="POST" action="action/aksi-edit-prestasi.php?id=<?php echo $id_Prestasi?>" enctype='multipart/form-data'>
      <div class="card mb-3">
        <div class="row g-0">
          <div class="col-md-4">          
          <label>
                <div class="image-holder">
                  ...
                  <img src="../foto/<?php echo $d['Foto_Prestasi']; ?>" class="d-block w-100" alt="...">
                  </div>
                <input style="visibility:hidden" type='file' name='Foto_Prestasi'>
              </label>
              </div>
              <div class="col-md-8">
            <div class="card-body">
              <br>
              <textarea name="Judul_Prestasi" class='form-control' placeholder='Judul Prestasi' value=""><?php echo $d['Judul_Prestasi'] ?></textarea>
              <br>
              <textarea name="Keterangan_Prestasi" class='tinymce' placeholder='Keterangan Prestasi' value=""><?php echo $d['Keterangan_Prestasi'] ?></textarea>
            </div>
          </div>
        </div>
      </div>
